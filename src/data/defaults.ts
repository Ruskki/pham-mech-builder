...
export const DEFAULT_ARCHETYPES: ArchetypeOption[] = [
  { cost: 3, languages: { en: { label: 'Striker' }, es: { label: 'Atacante' } } },
  { cost: 4, languages: { en: { label: 'Tank' }, es: { label: 'Tanque' } } },
  { cost: 2, languages: { en: { label: 'Support' }, es: { label: 'Soporte' } } },
  { cost: 2, languages: { en: { label: 'Scout' }, es: { label: 'Explorador' } } },
  { cost: 5, languages: { en: { label: 'Artillery' }, es: { label: 'Artillería' } } },
  { cost: 4, languages: { en: { label: 'Stealth' }, es: { label: 'Sigilo' } } },
];
